...
class Clipper
    /*Áàçîâûé êëàññ, ïðåäíàçíà÷åííûé äëÿ ìîäåðíèçàöèè ðàçëè÷íûìè
    òèïàìè êëèïïåðîâ, òàêèìè êàê Hard, Soft, Sine, Triangle, Foldback.
    Èìååò ÷èñòóþ âèðòóàëüíóþ ôóíêöèþ process, òðåáóþùóþ ïåðåîïðåäåëåíèÿ
    íàñëåäîâàííûì êëàññîì.*/
{
public:
...
protected:
    ...
    double multiplier;
    /*êîððåêòèðóþùèå êîýôôèöèåíòû çàäàþò èíòåíñèâíîñòü âëèÿíèÿ
    ïàðàìåòðà multiplier íà îáðàáîòêó. Ïðè ýòîì çíà÷åíèå âûâîäà
    ôóíêöèè correctMulti() äîëæíî áûòü ðàâíî 0.5 ïðè multiplier = 1,
    äëÿ ñîáëþäåíèÿ ëèíåéíîñòè ó÷àñòêà ïåðåäàòî÷íîé ôóíêöèè.*/    
...
private:
    double kneeThreshold{ 0.5 }; // âëèÿåò íà ðåçêîñòü çâó÷àíèÿ. Äîëæåí áûòü îò 0,2 äî 0,7 (íàéäåíî ýìïèðè÷åñêè)
